#ifndef mytruth_readtruth_hhbbwwlvlv_chkweight_H
#define mytruth_readtruth_hhbbwwlvlv_chkweight_H
...
class readtruth_hhbbwwlvlv_chkweight : public EL::Algorithm
{
...
public:
  ...
  TH1F*  lep1_viaemu_pT ; //!
  TH1F*  lep1_viaemu_eta ; //!
  TH1F*  lep1_viaemu_phi ; //!
  TH1F*  lep1_viaemu_E ; //!

  TH1F*  lep2_viaemu_pT ; //!
  TH1F*  lep2_viaemu_eta ; //!
  TH1F*  lep2_viaemu_phi ; //!
  TH1F*  lep2_viaemu_E ; //!

  // e mu leptons from tau exclusively
  TH1F*  lep1_viatau_pT ; //!
  TH1F*  lep1_viatau_eta ; //!
  TH1F*  lep1_viatau_phi ; //!
  TH1F*  lep1_viatau_E ; //!

  TH1F*  lep2_viatau_pT ; //!
  TH1F*  lep2_viatau_eta ; //!
  TH1F*  lep2_viatau_phi ; //!
  TH1F*  lep2_viatau_E ; //!
  ...
  readtruth_hhbbwwlvlv_chkweight ();
  ...
  ClassDef(readtruth_hhbbwwlvlv_chkweight, 1);
};
