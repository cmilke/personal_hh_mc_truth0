#ifndef mytruth_readtruth_hhbbttlvlv_H
#define mytruth_readtruth_hhbbttlvlv_H
...
class readtruth_hhbbttlvlv : public EL::Algorithm
{
...
public:
  ...
  ClassDef(readtruth_hhbbttlvlv, 1);
};
